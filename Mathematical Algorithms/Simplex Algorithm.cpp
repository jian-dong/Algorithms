...
/*
 The Simplex algorithm aims to solve a linear program - optimising a linear
 function subject to linear constraints. As such it is useful for a very wide
 ...
 Every linear program can be translated into slack form; the parameters to
 specify are:
