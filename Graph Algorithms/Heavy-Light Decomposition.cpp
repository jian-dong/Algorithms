...
/*
 Heavy-Light Decomposition algorithm for partitioning the edges of a tree into
 two groups - heavy and light. Can be used for efficient traversal from any node
 to the root of the tree, since there are at most log n light edges along that
 path; hence, we can skip entire chains of heavy edges. Complexity: O(n)
*/
