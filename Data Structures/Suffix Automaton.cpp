...
/*
 ...
 accepting all suffices of a given string. It is useful for a variety of
 actions, one of which is efficiently computing the longest common substring
 (LCS) between two strings. Complexity:    O(n) for constructing the automaton
 (character by character) O(m) for computing the LCS
*/
