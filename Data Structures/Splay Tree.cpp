...
/*
 Splay Tree data structure is an efficient self-balancing implementation of a
 binary search tree. Complexity:    O(log N) amortized for all operations
*/
...
SplayTree::SplayTree() { this->root = NULL; }

SplayTree::SplayTree(TreeNode *rt) { this->root = rt; }
...
void SplayTree::inOrderPrint(bool brackets) { printTree(this->root, brackets); }
