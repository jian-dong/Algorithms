...
/*
 ...
 Complexity:    O(1) for: isEmpty, insert, getMinimum, decreaseKey and merge.
                O(N) for: extractMinimum and Delete (if we're deleting the
 minimum).
*/
...
bool CircularDoublyLinkedList::isEmpty() { return (this->first == NULL); }
...
Node *CircularDoublyLinkedList::getMinimum() { return this->minimum; }
...
void CircularDoublyLinkedList::merge(CircularDoublyLinkedList *cdll) {
  /*
   ...
   and then inserting that entire list before the first pointer in the original
   list.
